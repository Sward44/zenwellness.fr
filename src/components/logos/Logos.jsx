export function ZenwellnessFavicon() {
  return (
    <svg viewBox="0 0 512 512">
      ...
      >
        <stop
          offset="0"
          stopColor="var(--color-wild-sand-50)"
          stopOpacity="1"
        />
        <stop
          offset="0.45"
          stopColor="var(--color-marigold-yellow-200)"
          stopOpacity="0.9"
        />
        <stop
          offset="0.9"
          stopColor="var(--color-vida-loca-600)"
          stopOpacity="0.95"
        />
        <stop offset="1" stopColor="var(--color-dell-800)" stopOpacity="1" />
      </radialGradient>
      <path
        fill="url(#2)"
        d="M55.26 244.71
